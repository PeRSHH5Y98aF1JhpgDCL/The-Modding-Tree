var systemComponents = {
	...
	'overlay-head': {
		...
		<br>
		<span v-if="player.points.lt('1e1000')"  class="overlayThing">You are at </span>
		<span v-if="player.points.lt('1e1e6')"  class="overlayThing"> {{modInfo.pointsName}}</span>
		<h2  class="overlayThing" id="points">{{format(player.points)}}</h2><br>
		<span>Endgame: <span v-html="modInfo.endGame" /></span>
		<br>
